...
test: $(TESTDIRS)
	...
	gcovr --object-directory ./coverage --exclude '/usr' --exclude '${PWD}/test/mbed-client-mbed-os/unittest/' --exclude '/yotta_modules/' --exclude '${PWD}/coverage/' -x -o ./lcov/gcovr.xml
